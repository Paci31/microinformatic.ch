...
export default function Contact() {
  ...
  function submit(e) {
    e.preventDefault();
    setStatus(
      "Message envoyé (démo). Connectez ce formulaire à votre backend IIS/Node/PHP."
    );
  }
      ...
      <div className="mt-6 grid gap-6 md:grid-cols-2">
        <div className="glass rounded-2xl p-6 shadow-soft">
          <form onSubmit={submit} className="grid gap-4">
            <div>
              ...
              <input
                className="mt-1 w-full rounded-xl border border-slate-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-mis-teal"
                required
        ...
        <div className="glass rounded-2xl p-6 shadow-soft">
          ...
          <p className="mt-2 text-slate-700">
            Micro Informatic Systems SA
            <br />
            En Chamard 41A
            <br /> 1442 Montagny-près-Yverdon
            <br />
            +41 (0)24 447 44 70
            <br />
            info@microinformatic.ch
          </p>
        </div>
      </div>
    </section>
